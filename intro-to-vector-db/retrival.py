...
def main():
    print("Retrival of data from vector DB ...")
    ...
    # retrival_chain = create_retrieval_chain(retriever=vector_store.as_retriever(), combine_docs_chain=combine_docs_chain)

    # result = retrival_chain.invoke(input={"input": query})

    # print(result)

    template = """Use the following peiced of context to answer the question at the end.
